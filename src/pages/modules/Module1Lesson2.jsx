  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <h1>1.2  Theory & Knowledge Building</h1>
        ...
        <div dangerouslySetInnerHTML={{ __html: `<!-- Level Map -->
      <div style="background:var(--grey-bg); border:1px solid var(--grey-border); border-radius:10px; padding:18px 22px; margin-bottom:24px;">
        <h3 style="color:var(--blue-dark); margin-bottom:12px; font-size:0.97em;">Your Learning Path Through This Section</h3>
        ...
        <div className="accordion">
          <div className="accordion-item">
            ...
            >
              <span>Part 1 — Building Sentences</span>
              <span className="accordion-icon">▼</span>
            </button>
            {activeAccordion === 0 && (
              <div className={`accordion-content ${activeAccordion === 0 ? 'active' : ''}`}>
                <div dangerouslySetInnerHTML={{ __html: `<div class="level-section-header a2" id="a2-start">
        <span class="level-badge level-a2" style="font-size:0.95em; padding:5px 14px;"></span>
      ...
      <div class="theory-block">
        <h3>Quick Practice (A2) — Complete These Sentences</h3>
        ...
        <div className="accordion">
          <div className="accordion-item">
            ...
            >
              <span>Part 2 — The Academic Paragraph</span>
              <span className="accordion-icon">▼</span>
            </button>
            {activeAccordion === 1 && (
              <div className={`accordion-content ${activeAccordion === 1 ? 'active' : ''}`}>
                <div dangerouslySetInnerHTML={{ __html: `<div class="level-section-header a2" id="a2-para">
      ...
      <div class="theory-block">
        ...
        <div className="accordion">
          <div className="accordion-item">
            ...
            >
              <span>Part 3 — The Four-Paragraph Academic Essay</span>
              <span className="accordion-icon">▼</span>
            </button>
            {activeAccordion === 2 && (
              <div className={`accordion-content ${activeAccordion === 2 ? 'active' : ''}`}>
                <div dangerouslySetInnerHTML={{ __html: `<div class="level-section-header b1" id="b1-essay">
      ...
      <div class="info-box info-box-blue">
        ...
        <div className="accordion">
          <div className="accordion-item">
            ...
            >
              <span>Part 4 — Thesis Statements &amp; Topic Sentences</span>
              <span className="accordion-icon">▼</span>
            </button>
            {activeAccordion === 3 && (
              <div className={`accordion-content ${activeAccordion === 3 ? 'active' : ''}`}>
                <div dangerouslySetInnerHTML={{ __html: `<div class="level-section-header b1" id="b1-thesis">
      ...
      <div class="theory-block">
        ...
        <div className="accordion">
          <div className="accordion-item">
            ...
            >
              <span>Part 5 — The Opinion (Argumentative) Essay</span>
              <span className="accordion-icon">▼</span>
            </button>
            {activeAccordion === 4 && (
              <div className={`accordion-content ${activeAccordion === 4 ? 'active' : ''}`}>
                <div dangerouslySetInnerHTML={{ __html: `<div class="level-section-header b1" id="b1-opinion">
      ...
      <div class="theory-block">
        ...
        <div class="two-col" style="margin-top:12px;">
          <div style="background:var(--green-bg); border:2px solid var(--green-border); border-radius:8px; padding:14px 16px;">
            ...
            <ul style="font-size:0.87em; margin:0; margin-left: 5px;">
      ...
      <div class="theory-block">
        ...
        <div className="accordion">
          <div className="accordion-item">
            ...
            >
              <span>Part 6 — Academic Writing Conventions</span>
              <span className="accordion-icon">▼</span>
            </button>
            {activeAccordion === 5 && (
              <div className={`accordion-content ${activeAccordion === 5 ? 'active' : ''}`}>
                <div dangerouslySetInnerHTML={{ __html: `<div class="level-section-header b1" id="conventions">
      ...
      <div class="two-col">
        ...
        <div className="accordion">
          <div className="accordion-item">
            ...
            >
              <span>Part 7 — Academic Vocabulary Starter List</span>
              <span className="accordion-icon">▼</span>
            </button>
            {activeAccordion === 6 && (
              <div className={`accordion-content ${activeAccordion === 6 ? 'active' : ''}`}>
                <div dangerouslySetInnerHTML={{ __html: `<h2 class="section-title" id="vocabulary">Part 7 — Academic Vocabulary Starter List</h2>
